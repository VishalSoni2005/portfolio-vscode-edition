...
const WELCOME_MESSAGE = [
  ...
  "vishalsoni@macmini-pro portfolio-ide % npm start",
  "",
  "> vishal-soni@1.0.0 start",
  "> react-scripts start",
  "",
  "Starting the development server...",
  "",
  "Compiled successfully!",
  "You can now view vishal-soni in the browser.",
  "",
...
export const Terminal: React.FC = () => {
  ...
  const handleCommand = (cmd: string) => {
    ...
    // Prompt for history
    const prompt = "vishalsoni@macmini-pro portfolio-ide %";
    ...
    switch (trimmed) {
      ...
      case "ls":
        response = [
          "src  public  node_modules  package.json  README.md  tsconfig.json",
        ];
        break;
      case "pwd":
        response = ["/Users/vishalsoni/Documents/portfolio-ide"];
        break;
      case "":
        break;
      default:
